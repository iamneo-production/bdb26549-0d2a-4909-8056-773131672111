...
public class AdminController {
	...
	public InstituteModel saveOrUpdateAcademy(@PathVariable int instituteId, @RequestBody InstituteModel user) {

		return instituteDetailsService.updateInstitute(instituteId, user);
	}
	...
	public CourseModel getCourseByName(@PathVariable String courseName) {

		return courseService.viewCourseByName(courseName);
	}
...
// try {
// return
// ResponseEntity.status(HttpStatus.OK).body(this.courseService.getCourse(Long.parseLong(courseId)));
// }catch(Exception e){
// return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
// }
// }
...
// try {
// return
// ResponseEntity.status(HttpStatus.OK).body(this.courseService.addCourse(course));
// }catch(Exception e){
// return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
// }
// }
...
// try {
// return
// ResponseEntity.status(HttpStatus.OK).body(this.courseService.updateCourse(course));
// }catch(Exception e){
// return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
// }
// }
...
// try{
// return
// ResponseEntity.status(HttpStatus.OK).body(this.courseService.deleteCourse(Long.parseLong(courseId)));
// }catch(Exception e){
// //return
// ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("INTERNAL_SERVER_ERROR");
// return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
