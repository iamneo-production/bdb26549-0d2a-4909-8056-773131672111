...
function App() {
    return ( <
        ...
        <
        Route exact path = "/admin/addInstitute"
        element = { < AddAcademy / > } > < /Route> <
        Route exact path = "/admin/viewInstitutes"
        element = { < ViewAcademy / > } > < /Route> <
        Route exact path = "/admin/editInstitute/:instituteId"
        element = { < EditAcademy / > }
        />

        <
        Route exact path = "/admin/addCourse"
        element = { < AddCourse / > } > < /Route> <
        Route exact path = "/admin/viewCourse"
        element = { < ViewCourse / > } > < /Route> <
        Route exact path = "/admin/editCourse/:courseId"
        element = { < EditCourse / > } > < /Route>

        <
        Route exact path = "/admin/ViewStudent"
        element = { < ViewStudent / > } > < /Route>   <
        Route exact path = "/admin/addStudent/"
        element = { < AddStudent / > } > < /Route> <
        Route exact path = "/admin/updateStudent/:studentId"
        ...
        <
        Route exact path = "/user/viewacademy"
        element = { < Viewacademy / > } > < /Route> <
        Route exact path = '/user/enrolledCourse'
        element = { < EnrolledCourse / > } > < /Route> <
        Route exact path = '/user/viewacademycourses/:instituteId'
        element = { < ViewAcademyCourses / > } > < /Route>  <
        Route exact path = '/user/enrollForm'
        element = { < EnrollForm / > } > < /Route>
