...
const viewstudentByFirstName = (studentFirstName) => {
  axios.get(`http://localhost:8080/admin/viewStudentByName/${studentFirstName}`).then(
      (res) => {
          setStudent([]);
          setStudent([res.data]);
  ...
  const getDetails = () => {
    axios.get("http://localhost:8080/admin/viewStudents").then((response) => {
  ...
  const deleteStudent = (studentId) => {
    axios
      .delete(`http://localhost:8080/admin/deleteStudent/${studentId}`)
      .then((res) => {
        setDel(res.data);
        console.log(res.data);
        getDetails();
                                ...
                                <div className="form">
                                    <div className='row'>
                                        <div className='col-9'>
                                            ...
                                            placeholder='Type here to search student' value={studentFirstName}
