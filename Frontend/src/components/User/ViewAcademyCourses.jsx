...
function ViewAcademyCourses() {
    ...
    const getDetails = () => {
        axios.get(`http://localhost:8080/admin/getCourseByInstituteName/${params.state.instituteId}`).then(
            (response) => {
    ...
    const enrollCourse = (courseId, duration) => {
        ...
        axios.get(`http://localhost:8080/admin/checkStudentMailId/${users}`).then(
            (res) => {
                console.log("1")
                if (!res.data) {
                    ...
                    axios.get("http://localhost:8080/admin/checkAdmission/" + users + "/" +courseId).then((resource) => {
                        ...
                        if (!resource.data) {
                            ...
                            axios.put("http://localhost:8080/admin/addAdmission/" +users,enrollCourse).then((reso) => {
